...
class EnterDestinationViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        destinationList.delegate = self
        destinationList.dataSource = self
